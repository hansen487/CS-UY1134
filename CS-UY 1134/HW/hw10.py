...
class AVLTreeMap(TreeMap):
  ...
  def left_height(self, p):
      return p._node._left._balance_factor if p._node._left is not None else 0
  
  def right_height(self, p):
      return p._node._right._balance_factor if p._node._right is not None else 0
...
for i in T:
	print(T[i])
print(T.root()._node._balance_factor)
p = T.root()
while T.left(p) != None:
    p = T.left(p)
...
#T = AVLTreeMap()
#T._add_root(44)
#T._add_left(T.root(), 23)
#T._add_left(T.left(T.root()), 22)
#print(T.root()._node._balance_factor)
#print(T.root()._node._balance_factor)
#print(T._isbalanced(T.root()))
#T._rebalance(T.root())
#print(T._isbalanced(T.root()))
